...
local PlayerESP = {
    ...
    aimbotGroundDuration = 0.01,     -- 瞄地面持续时间（0.5秒）
...
function PlayerESP:toggleThirdPerson()
    ...
    if self.thirdPersonToggleBtn then
        ...
        self.thirdPersonToggleBtn.BackgroundColor3 = self.forceThirdPerson and Color3.fromRGB(76, 175, 80) or Color3.fromRGB(244, 67, 54)
    end
end
...
function PlayerESP:createUI()
    ...
    self.thirdPersonToggleBtn.MouseButton1Click:Connect(function() self:toggleThirdPerson() end)
